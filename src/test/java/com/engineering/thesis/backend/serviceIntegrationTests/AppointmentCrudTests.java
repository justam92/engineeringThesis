...
public class AppointmentCrudTests {
    ...
    void shouldThrowExceptionWhenSaveAppointmentWithExistingID() {
        ...
        assertThrows(RuntimeException.class, () -> appointmentServiceImpl.create(null));
    ...
    void shouldThrowExceptionWhileUpdateAppointment() {
        ...
        assertThrows(ResourceNotFoundException.class, () -> appointmentServiceImpl.updateById(1L, Appointments.appointment1));
        verify(appointmentRepository, never()).save(any(Appointment.class));
    }
    ...
    void shouldReturnSelectAll() {
        ...
        List<Appointment> expected = appointmentServiceImpl.getAll();
    ...
    void shouldFindAppointmentById() throws ResourceNotFoundException {
        ...
        final Optional<Appointment> expected = appointmentServiceImpl.getById(id);
