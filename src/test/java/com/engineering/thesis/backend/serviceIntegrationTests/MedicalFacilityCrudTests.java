...
public class MedicalFacilityCrudTests {
    ...
    void shouldThrowExceptionWhenSaveMedFacWithExistingID() {
        ...
        assertThrows(RuntimeException.class, () -> medFacServiceImpl.create(null));
    ...
    void shouldThrowExceptionWhileUpdateMedFac() {
        ...
        assertThrows(ResourceNotFoundException.class, () -> medFacServiceImpl.updateById(1L, MedicalFacilities.medicalFacility1));
        verify(medFacRepository, never()).save(any(MedicalFacility.class));
    }
    ...
    void shouldReturnSelectAll() {
        ...
        List<MedicalFacility> expected = medFacServiceImpl.getAll();
    ...
    void shouldFindMedFacById() throws ResourceNotFoundException {
        ...
        final Optional<MedicalFacility> expected = medFacServiceImpl.getById(id);
